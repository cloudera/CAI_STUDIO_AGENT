...
# Runtime filtering constants
AGENT_STUDIO_RUNTIME_KERNEL = "Agent Studio"
AGENT_STUDIO_RUNTIME_EDITION = "Agent Studio"
...
MCP_TEMPLATE_ICONS_LOCATION = f"{DYNAMIC_ASSETS_LOCATION}/mcp_template_icons"
MCP_INSTANCE_ICONS_LOCATION = f"{DYNAMIC_ASSETS_LOCATION}/mcp_instance_icons"
