...
def package_workflow_for_deployment(payload: DeploymentPayload, deployment: DeployedWorkflowInstance, session: Session, cml: CMLServiceApi) -> DeploymentArtifact:
    """
    ...
    shutil.copytree(
        "studio-data", os.path.join(packaging_directory, "studio-data"), ignore=studio_data_workflow_ignore
    )
    ...
    return DeploymentArtifact(
        project_location=deployment_artifact_path
    )