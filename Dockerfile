# Stage 1: Build stage
FROM docker.repository.cloudera.com/cloudera/cdsw/ml-runtime-pbj-workbench-python3.10-standard:2025.06.1-b5 AS builder
...
ENV ML_RUNTIME_EDITION=$ML_RUNTIME_EDITION \
    ...
    ML_RUNTIME_FULL_VERSION="$RT_SHORT_VERSION.$ML_RUNTIME_MAINTENANCE_VERSION" \
